...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.linePass1.setGeometry(QRect(130, 41, 301, 22))
        self.linePass1.setReadOnly(True)
        self.datePass1 = QLabel(self.centralwidget)
        self.datePass1.setObjectName(u"datePass1")
        self.datePass1.setGeometry(QRect(440, 41, 131, 20))
        self.label_2 = QLabel(self.centralwidget)
        self.label_2.setObjectName(u"label_2")
        self.label_2.setGeometry(QRect(10, 9, 171, 31))
        self.checkBox = QCheckBox(self.centralwidget)
        self.checkBox.setObjectName(u"checkBox")
        self.checkBox.setGeometry(QRect(10, 190, 211, 20))
        self.progressBar = QProgressBar(self.centralwidget)
        self.progressBar.setObjectName(u"progressBar")
        self.progressBar.setGeometry(QRect(10, 300, 481, 23))
        ...
        self.textEdit.setGeometry(QRect(10, 330, 481, 131))
        self.textEdit.setReadOnly(True)
        self.lineEdit_2 = QLineEdit(self.centralwidget)
        self.lineEdit_2.setObjectName(u"lineEdit_2")
        self.lineEdit_2.setGeometry(QRect(10, 260, 361, 22))
        self.pushButton_2 = QPushButton(self.centralwidget)
        self.pushButton_2.setObjectName(u"pushButton_2")
        self.pushButton_2.setGeometry(QRect(380, 260, 111, 24))
        self.label_3 = QLabel(self.centralwidget)
        self.label_3.setObjectName(u"label_3")
        self.label_3.setGeometry(QRect(10, 60, 221, 31))
        self.linePass2 = QLineEdit(self.centralwidget)
        self.linePass2.setObjectName(u"linePass2")
        self.linePass2.setGeometry(QRect(130, 92, 301, 22))
        self.linePass2.setReadOnly(True)
        self.pushButton2 = QPushButton(self.centralwidget)
        self.pushButton2.setObjectName(u"pushButton2")
        self.pushButton2.setGeometry(QRect(10, 91, 111, 24))
        self.datePass2 = QLabel(self.centralwidget)
        self.datePass2.setObjectName(u"datePass2")
        self.datePass2.setGeometry(QRect(440, 92, 131, 20))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.datePass1.setText(QCoreApplication.translate("MainWindow", u"TextLabel", None))
        self.label_2.setText(QCoreApplication.translate("MainWindow", u"\u041f\u0435\u0440\u0435\u0447\u0435\u043d\u044c \u044d\u043b\u0435\u043c\u0435\u043d\u0442\u043e\u0432:", None))
        self.checkBox.setText(QCoreApplication.translate("MainWindow", u"\u041e\u0442\u043a\u0440\u044b\u0442\u044c \u043f\u043e\u0441\u043b\u0435 \u0437\u0430\u0432\u0435\u0440\u0448\u0435\u043d\u0438\u044f", None))
        ...
        self.datePass2.setText(QCoreApplication.translate("MainWindow", u"TextLabel", None))
